...
from experiments.functiongemma.v8_curriculum import write_v8_dataset
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "exact-runtime semantic v7 rows, or add authenticated handoff and live-failure "
            "corrections in v8."
        ),
    )
    return parser
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.curriculum_version == "v8":
        manifest = write_v8_dataset(args.output_dir, sizes, seed=args.seed)
