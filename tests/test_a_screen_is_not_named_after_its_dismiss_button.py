...
Measured 2026-08-10: a sign-up sheet headed "Create your account", with "Continue with Google" and
"Maybe later" under it, was recorded in the map as the screen `cancel`. The agent that met it
wrote that `cancel` was "a misleading map name for the account sheet" and based its verdict on the
raw element text instead — the map entry was worse than none, because it had to be actively
disbelieved.
...
@pytest.mark.parametrize(
    "label",
    ["Settings", "Your apps", "Search", "Checkout", "Backup", "Nextdoor"],
)
