...
def _strip_glyph_tokens(text: str) -> str:
    ...
    "Continue with Example ID" with an E icon beside it comes back as "E Continue with
    Example ID". That reading is *longer* than the tree's text, so a containment test - even a
