...
def _capture_files(device: Device, package: str, database: str) -> dict[str, bytes]:
    ...
    names = [database]
    names.extend(
        f"{database}{suffix}" for suffix in _SIDECAR_SUFFIXES if f"{database}{suffix}" in available
    )
