...
class Meta(BaseModel):
    ...
    # Calls the app started that nothing has answered yet, as ["POST /v1/auth/login"], recent
    # ones only. A screen mid-load and an idle screen are the same hierarchy, so without this
