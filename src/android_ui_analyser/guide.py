...
SESSION_PROTOCOL: list[tuple[str, str]] = [
    ...
    (
        ...
        "exact decision-complete `save_call` (including `--force` for a collision). The write "
        "still rechecks atomically; preview is never race authorization. Add `--save` only after "
