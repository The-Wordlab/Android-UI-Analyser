...
RUNTIME_CAPABILITIES: dict[str, CapabilitySpec] = {
    ...
    "device.recording": _spec(
        ...
        CapabilityScope.RUNTIME,
        "active_recording",
        "clear_failed_recording_state",
        "failed_recording_start",
        "recording_destination",
        "start_recording",
        "stop_recording",
        "discard_recording",
        "recording_is_inert",
        inherited_defaults=("recording_is_inert", "clear_failed_recording_state", "failed_recording_start"),
    ),
    "device.recording.recovery": _spec(
        "device.recording.recovery",
        CapabilityScope.RUNTIME,
        "archive_stale_recording",
        "recording_path_is_unrecoverable",
        inherited_defaults=("recording_path_is_unrecoverable",),
    ),
